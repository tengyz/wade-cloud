...
public interface Constant {
     ...
     * 是否关闭送会签必选财务部校验
     */
    public static String IS_VAILD_FINANCE_ORG = "isVaildFianceOrg";
    /**
     * 是否开启非融资租赁审批过的标准文本权限查看
     */
    public static String IS_QUERY_PERMISSIONS = "isQueryPermissions";
    /**
     * 是否开启单合同签约权限
     */
    public static String IS_SINGLE_CONTRACT_PERMISSION = "isSingleContractPermission";
    /**
     * 应急登陆
     */
    ...
    public static final Long PROVINCE_NAME_CATAID=16001L;
}
